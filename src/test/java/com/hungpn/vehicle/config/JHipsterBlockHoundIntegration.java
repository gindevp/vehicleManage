package com.hungpn.vehicle.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.hungpn.vehicle.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.hungpn.vehicle.security.DomainUserDetailsService", "createSpringSecurityUser");
