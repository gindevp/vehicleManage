...
public class VehicleTestSamples {
    ...
    public static Vehicle getVehicleSample1() {
        return new Vehicle().id(1L).name("name1").type(1L);
    }

    public static Vehicle getVehicleSample2() {
        return new Vehicle().id(2L).name("name2").type(2L);
    }

    public static Vehicle getVehicleRandomSampleGenerator() {
        return new Vehicle().id(longCount.incrementAndGet()).name(UUID.randomUUID().toString()).type(longCount.incrementAndGet());
    }
}
